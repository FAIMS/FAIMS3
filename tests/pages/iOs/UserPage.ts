...
class UserPage extends Page {
  get currentUser() {
    return $('//XCUIElementTypeStaticText[@name="CURRENT USER"]');
  }
  get workspaceButton() {
    return $('//XCUIElementTypeButton[@name="WORKSPACE"]');
  }
  get switchButton() {
    return $('//XCUIElementTypeButton[@name="SWITCH"]');
  }
  get logOutButton() {
    return $('//XCUIElementTypeButton[@name="LOG OUT"]');
  }
  get addAnotherUserButton() {
    return $('//XCUIElementTypeButton[@name="ADD ANOTHER USER"]');
  }
  get refreshButton() {
  ...
  async getCurrentUserText() {
    await this.currentUser.waitForDisplayed({
  ...
  async addAnotherUserButtonClick() {
    await this.addAnotherUserButton.waitForDisplayed({
      timeout: await this.getWaiterTimeForElement(),
    });
