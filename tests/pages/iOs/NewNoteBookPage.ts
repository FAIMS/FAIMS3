...
class UserPage extends Page {
  get projectNameField() {
    return $(
      '//XCUIElementTypeStaticText[@name="Project Name"]/../..//XCUIElementTypeTextField'
    );
  }

  get descriptionField() {
    return $(
      '//XCUIElementTypeStaticText[@name="Description"]/../..//XCUIElementTypeTextView'
    );
  }

  get leadField() {
    return $(
      '//XCUIElementTypeStaticText[@name="Lead"]/../..//XCUIElementTypeTextField'
    );
  }

  get leadInstitution() {
    return $(
      '//XCUIElementTypeStaticText[@name="lead_institution"]/../..//XCUIElementTypeTextField'
    );
  }
  ...
  get metaField() {
    return $(
      '//XCUIElementTypeStaticText[@name="Add new meta data Label"]/../../XCUIElementTypeTextField'
    );
  }
  ...
  get userRoles() {
    return $(
      '//XCUIElementTypeStaticText[@name="Add User Roles"]/../../XCUIElementTypeTextField'
    );
  }

  get imageDrop() {
    return $(
      '//XCUIElementTypeStaticText[@name="Drag \'n\' drop some files here, or click to select files"]'
    );
  }
  ...
  get inheritAccess() {
    return $(
      '//XCUIElementTypeStaticText[@name="Inherit Access from Notebook"]'
    );
  }
  ...
  get inputTextField() {
    return $(
      '//XCUIElementTypeOther[@name="COMPONENT, tab panel"]/XCUIElementTypeButton[2]'
    );
  }
  ...
  async metaTabClick() {
    await this.metaTab.waitForDisplayed({
      timeout: await this.getWaiterTimeForElement(),
    });
  ...
  async userRoleTabClick() {
    await this.userRoleTab.waitForDisplayed({
      timeout: await this.getWaiterTimeForElement(),
    });
  ...
  async metaAddClick() {
    await this.metaRolesAdd.waitForDisplayed({
      timeout: await this.getWaiterTimeForElement(),
    });
  ...
  async imageDropClick() {
    await this.imageDrop.waitForDisplayed({
      timeout: await this.getWaiterTimeForElement(),
    });
  ...
  async imageLibraryDropClick() {
    await this.imageLibraryDrop.waitForDisplayed({
      timeout: await this.getWaiterTimeForElement(),
    });
  ...
  async imageLibraryFileClick() {
    await this.imageFromLibrary.waitForDisplayed({
      timeout: await this.getWaiterTimeForElement(),
    });
  ...
  async imageLibraryAddClick() {
    await this.imageFromLibraryAdd.waitForDisplayed({
      timeout: await this.getWaiterTimeForElement(),
    });
  ...
  async inheritAccessClick() {
    await this.inheritAccess.waitForDisplayed({
      timeout: await this.getWaiterTimeForElement(),
    });
  ...
  async submitClick() {
    await this.submitNoteBookTab.waitForDisplayed({
      timeout: await this.getWaiterTimeForElement(),
    });
  ...
  async saveClick() {
    await this.saveNoteBookTab.waitForDisplayed({
      timeout: await this.getWaiterTimeForElement(),
    });
  ...
  async getNoteBookPresent() {
    await this.noteBookNameAppium.waitForDisplayed({
      timeout: await this.getWaiterTimeForElement(),
    });
  ...
  async refreshClick() {
    await this.refreshNoteBook.waitForDisplayed({
      timeout: await this.getWaiterTimeForElement(),
    });
  ...
  async infoTabClick() {
    await this.infoTabNoteBook.waitForDisplayed({
      timeout: await this.getWaiterTimeForElement(),
    });
  ...
  async settingsTabClick() {
    await this.settingsTabNoteBook.waitForDisplayed({
      timeout: await this.getWaiterTimeForElement(),
    });
  ...
  async recordsTabClick() {
    await this.recordsTabNoteBook.waitForDisplayed({
      timeout: await this.getWaiterTimeForElement(),
    });
  ...
  async draftTabClick() {
    await this.draftsInnerTabNoteBook.waitForDisplayed({
      timeout: await this.getWaiterTimeForElement(),
    });
  ...
  async innerRecordsTabClick() {
    await this.recordsInnerTabNoteBook.waitForDisplayed({
      timeout: await this.getWaiterTimeForElement(),
    });
  ...
  async newRecordButtonClick() {
    await this.newRecordButton.waitForDisplayed({
      timeout: await this.getWaiterTimeForElement(),
    });
