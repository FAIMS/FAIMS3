...
export const TestComponent = () => {
  ...
  const refreshActive = async () => {
    if (activeConnection) {
      await refreshToken(activeConnection.serverId, activeConnection.username)
    }
  }
    ...
    <div style={containerStyle}>
      ...
      <div style={sectionStyle}>
        ...
        {selectedServer && selectedUser && (
          <div>
            <button 
              onClick={() => setActiveConnection(selectedServer, selectedUser)}
              style={buttonStyle}
            >
              Set As Active
            </button>
            <button 
              onClick={() => removeServerConnection(selectedServer, selectedUser)}
