 ...
 * 
 * A secure React component for rendering markdown content with HTML support.
 * This component implements multiple layers of security to safely render user-generated
 * content while preventing XSS attacks and other security vulnerabilities.
 * 
 * Security Features:
 ...
 * 
 * @security This component uses dangerouslySetInnerHTML, but implements multiple 
 * safeguards to prevent XSS attacks. All HTML is sanitized before rendering.
 */
...
const purifyConfig: Config = {
  ...
  ALLOWED_ATTR: [
    // General attributes - Basic styling and identification
    'id',
    'class',

    // Media attributes - Required for images
    'src',
    'alt',
    'title',

    // Link attributes - Required for anchors
    'href',
    'target',
    'rel',
  ],
...
export const RichTextField: React.FC<Props> = ({content}) => {
  ...
  // 2. Sanitize the HTML
  // 3. Render the sanitized content
