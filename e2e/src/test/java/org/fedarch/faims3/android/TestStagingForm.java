...
public class TestStagingForm extends AndroidTest {
  ...
  public void testSwitchTab() {
	  try {
			...
			TestUtils.scrollUpUntilVisible(MobileBy.xpath("//*[@resource-id='project-nav-scrollable-tab-projectB']"), driver).click();
			...
			AndroidElement currencies = TestUtils.scrollDownUntilVisible(MobileBy.xpath("//*[@resource-id='multi-str-field']"), driver);
	  ...
	  TestUtils.markBrowserstackTestResult(driver, true, "Android - TestStagingForm.testSwitchTab() passed!");
  }
