<<<<<<< Updated upstream:e2e/src/test/java/org/fedarch/faims3/android/TestUtils.java
/*
...
>>>>>>> Stashed changes:e2e/src/test/java/org/fedarch/faims3/chrome/TestUtils.java
...
public class TestUtils {
	 ...
	 * @param driver AndroidDriver
	 */
	public static void loadNewLakeMungoForm(AndroidDriver<AndroidElement> driver) {
		// Click on "Projects"
		AndroidElement projects = (AndroidElement) new WebDriverWait(driver, 10).until(
			        ExpectedConditions.elementToBeClickable(MobileBy.xpath ("//android.view.MenuItem[contains(@text, 'Projects')]")));
		projects.click();

		// Get the right project
		AndroidElement lakeMungo = (AndroidElement) new WebDriverWait(driver, 10).until(
		        ExpectedConditions.presenceOfElementLocated(MobileBy.xpath(
		        		"//*[@text='Lake Mungo Archaeological Survey - 2018']")));
	    // Find the '+' button
		AndroidElement newButton = (AndroidElement) lakeMungo.findElementByXPath(
