...
public class AstroSky {
	 ...
	 */
	public static void fillOutFormWithValidFields(WebDriver driver) {
		WebDriverWait wait = new WebDriverWait(driver, 10);
		// Test GPS point
		WebElement gpsPoint = wait.until(
		        ExpectedConditions.elementToBeClickable(By.xpath("//*[@text='TAKE POINT']")));
		gpsPoint.click();
		// Make sure the point text has been updated
		wait.until(
		        ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@text='Lat: ']")));
		// now check that the point was captured
		validateLatLong(driver);

		// Click on Action button
	    // The value will be updated in JSON
		WebElement action = driver.findElement(MobileBy.xpath("//*[@text='ACTION!']"));
		action.click();

	    // Email field
	    WebElement emailField = driver.findElement(MobileBy.xpath("//*[@resource-id='email-field']"));
	    emailField.sendKeys(AstroSky.EMAIL);

	    TestUtils.scrollDown(driver);

	    // Colour field
	    WebElement strField = driver.findElement(MobileBy.xpath("//*[@resource-id='str-field']"));
	    strField.sendKeys(AstroSky.COLOUR);

	    // Text area - test unicode
	    WebElement textField = driver.findElement(MobileBy.xpath("//*[@resource-id='multi-str-field']"));
	    ...
	    WebElement intField = driver.findElement(By.xpath("//*[@resource-id='int-field']"));
	    //intField.sendKeys(AstroSky.INTEGER);

	    // Currency field
	    WebElement currencyField = driver.findElement(MobileBy.xpath("//*[@resource-id='select-field']"));
	    currencyField.click();
	 ...
	 * @param driver
	 */
	public static void validateLatLong(WebDriver driver) {
		...
		List<WebElement> gpsInfo = driver.findElements(By.xpath("//*[@text='Lat: ']/../" + className));
	 ...
	 */
	public static boolean validateJSON(WebDriver driver) throws JSONException, AssertionError {
		// Find JSON
		WebDriverWait wait = new WebDriverWait(driver, 10);
