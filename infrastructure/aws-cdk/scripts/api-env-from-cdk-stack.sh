...
#   ./scripts/api-env-from-cdk-stack.sh <stack-name> [--region REGION] [-o OUTPUT]
#
# Examples:
#   ./scripts/api-env-from-cdk-stack.sh my-faims-stack
#   ./scripts/api-env-from-cdk-stack.sh my-faims-stack -o ../../api/.env -r ap-southeast-2
#
...
{
  echo "# Generated by infrastructure/aws-cdk/scripts/api-env-from-cdk-stack.sh"
...
echo "Merge into api/.env after review: cp ${OUTPUT_FILE} ${API_DIR}/.env" >&2
