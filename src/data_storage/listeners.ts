...
import {RecordRevisionListing, listFAIMSRecordRevisions} from '.';
...
export const FAIMSRecordRevisionsTracker = new DBTracker<
  [ProjectID, RecordID],
  RecordRevisionListing
>(listFAIMSRecordRevisions, ['project_data_paused', listFAIMSRecordRevisions]);
