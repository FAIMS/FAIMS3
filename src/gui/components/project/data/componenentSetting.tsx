  ...
  const handlerchangewithviewSpec = (event: any, view: string) => {
    ...
    if(view==='other'){
      ...
      if(name==='field_type'){
        ...
        if(value!=='default'){
          const newvalues = props.uiSpec;
          newvalues['fields'][props.fieldName]['component-parameters']['InputProps']['type']=value
          switch (value) {
            case 'string':
              newvalues['fields'][props.fieldName]['type-returned']='faims-core::String';
              newvalues['fields'][props.fieldName]['validationSchema']=[
              ['yup.string']]
              if(newvalues['fields'][props.fieldName]['component-parameters']['required']) newvalues['fields'][props.fieldName]['validationSchema']=[
                ['yup.string'],['yup.required']]
              break;
            case 'number':
              newvalues['fields'][props.fieldName]['validationSchema']=newvalues['fields'][props.fieldName]['type-returned']='faims-core::Integer';
              newvalues['fields'][props.fieldName]['validationSchema']=[
                ['yup.number'],
              ]
              if(newvalues['fields'][props.fieldName]['component-parameters']['required']) newvalues['fields'][props.fieldName]['validationSchema']=[
                ['yup.number'],['yup.required']]
              break;
            case 'email':
              newvalues['fields'][props.fieldName]['type-returned']='faims-core::Email';
              newvalues['fields'][props.fieldName]['validationSchema']=[
                ['yup.string'],
              ...
              if(newvalues['fields'][props.fieldName]['component-parameters']['required']) newvalues['fields'][props.fieldName]['validationSchema']=[
                ['yup.string'],
                ['yup.email', 'Enter a valid email'],['yup.required']]
              break;
            default:
              break;
...
const getuivalue = (
  ...
  if (designvalue === 'settings') {
    ...
    if(uiSpec['fields'][fieldName]['component-name']==='TextField'){
      uiSetting['viewsets']['valid']['views']=['other','FormParamater', 'validationSchema']
    }
