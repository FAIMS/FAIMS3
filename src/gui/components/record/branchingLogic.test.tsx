...
const testUiSpecification = {
  ...
  fields: {
    ...
    newfielde23848d82: {
      ...
      'component-parameters': {
        fullWidth: true,
        name: 'newfielde23848d82',
        id: 'newfielde23848d82',
    ...
    hridLandscapeElementForm: {
      ...
      'component-parameters': {
        ...
        variant: 'filled',
        required: true,
        template: 'Element: {{newfieldb284a817}}-{{newfielde148d0b3e}}',
        InputProps: {
          type: 'text',
          readOnly: true,
        },
        ...
        fieldselect12: 'newfielde148d0b3e',
      },
    ...
    newfielde148d0b3e: {
      ...
      'type-returned': 'faims-core::String',
      'component-parameters': {
        name: 'newfielde148d0b3e',
        id: 'newfielde148d0b3e',
        variant: 'outlined',
        required: true,
        num_digits: 5,
    ...
    hridSurveyAreaForm: {
      ...
      'component-parameters': {
        ...
        variant: 'filled',
        required: true,
        template: 'Survey Area: {{newfield800c3f33}} {{newfielde1fa5e828}}',
        InputProps: {
          type: 'text',
          readOnly: true,
        },
        ...
        fieldselect11: 'newfielde1fa5e828',
    ...
    newfielde1fa5e828: {
      ...
      'component-parameters': {
        ...
        FormHelperTextProps: {},
        id: 'newfielde1fa5e828',
        name: 'newfielde1fa5e828',
      },
      validationSchema: [['yup.string']],
      initialValue: '',
      access: ['admin'],
