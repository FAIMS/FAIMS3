...
The {{Notebook}} will then be available to members of the new team.
...
```{screenshot} dashboard/dashboard-actions-status.png
:alt: Actions tab of the {{dashboard}} showing the status of the {{Notebook}}
:align: right
:width: 100%
```