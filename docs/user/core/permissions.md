...
The _Super User_ role has permission to do anything in the system
...
The _Operations Administrator_ role is intended for IT staff managing a deployment.
...
| can change the status of the {{notebook}} to _closed_                                           |  ❌   |     ❌      |   ✅    |      ✅       |
