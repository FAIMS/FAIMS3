...
To access the {{Notebook}}, open the App on your [Android]({{ANDROID_APP_LINK}}) or [Apple]({{IOS_APP_LINK}}) device, or your [browser]({{APP_URL}}), find the `Campus Survey Demo` {{notebook}}, [activate](../data-collection/activating-notebooks.md) and open it.
