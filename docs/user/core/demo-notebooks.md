...
1. [Demo Notebook](demo-notebooks-demo): a basic {{notebook}} showcasing the field types available in {{FAIMS}}
2. [Campus Survey Demo](demo-notebooks-campus-survey): a simple workflow designed for a testing the app a typical campus setting
