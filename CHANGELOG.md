...
- feat: any of or none of selectors for single select ([#2287](https://github.com/FAIMS/FAIMS3/pull/2287))
- Build/update android build ([#2286](https://github.com/FAIMS/FAIMS3/pull/2286))
- feat: Reference parent and related record values in field and section conditions ([#2279](https://github.com/FAIMS/FAIMS3/pull/2279))
- feat: adding updated timestamp to records, and managing rev/avp timestamps better ([#2276](https://github.com/FAIMS/FAIMS3/pull/2276))
- fix: keep the record list's identity stable across renders ([#2273](https://github.com/FAIMS/FAIMS3/pull/2273))
- feat: put the notebook tab in the route ([#2272](https://github.com/FAIMS/FAIMS3/pull/2272))
- Bring NotebookView and the plan view registry into FAIMS3 ([#2271](https://github.com/FAIMS/FAIMS3/pull/2271))
- fix: security - prevent header injection from form name ([#2264](https://github.com/FAIMS/FAIMS3/pull/2264))
- feat: read a record's field values from the data engine ([#2263](https://github.com/FAIMS/FAIMS3/pull/2263))
- feat: Reference related record values in templated and computed fields (#2256) ([#2261](https://github.com/FAIMS/FAIMS3/pull/2261))
- fix: double wrap of CDK exit code condition ([#2254](https://github.com/FAIMS/FAIMS3/pull/2254))
- refactor: move derived-value evaluation into data-model and modularise it (#2245) ([#2252](https://github.com/FAIMS/FAIMS3/pull/2252))
- feat: strengthening invite code generation ([#2251](https://github.com/FAIMS/FAIMS3/pull/2251))
- build: addressing minor ECS CDK warnings ([#2249](https://github.com/FAIMS/FAIMS3/pull/2249))
- feat: ttl cleanup script for expiring DB records + CDK wiring ([#2248](https://github.com/FAIMS/FAIMS3/pull/2248))
- feat: improved survey cleanup safety with tombstone DB ([#2247](https://github.com/FAIMS/FAIMS3/pull/2247))
- feat: Reference parent record values in templated and computed fields ([#2246](https://github.com/FAIMS/FAIMS3/pull/2246))
- chore: reverting to cap json config with prebuild scripting ([#2243](https://github.com/FAIMS/FAIMS3/pull/2243))
- build: adds new EBS recovery documentation and improves docs ([#2240](https://github.com/FAIMS/FAIMS3/pull/2240))
- build: individual iOS deploy lanes ([#2239](https://github.com/FAIMS/FAIMS3/pull/2239))
- Recursive record status report ([#2238](https://github.com/FAIMS/FAIMS3/pull/2238))
- Feature/2232 parent field display ([#2233](https://github.com/FAIMS/FAIMS3/pull/2233))
- Fix/Update asset generation script ([#2228](https://github.com/FAIMS/FAIMS3/pull/2228))
- fix: scope --clear-db volume pruning to this compose project ([#2225](https://github.com/FAIMS/FAIMS3/pull/2225))
- build: ts7 upgrade ([#2219](https://github.com/FAIMS/FAIMS3/pull/2219))
- Add dco.yml and allow remediation commits ([#2218](https://github.com/FAIMS/FAIMS3/pull/2218))
- Use repository name for the api docker image name ([#2217](https://github.com/FAIMS/FAIMS3/pull/2217))
- fix: distinguish an unloaded or incomplete record list from an empty one ([#2215](https://github.com/FAIMS/FAIMS3/pull/2215))
- refactor: extract record GIS feature hydration into a shared useRecordFeatures module ([#2212](https://github.com/FAIMS/FAIMS3/pull/2212))
- build(deps): bump json from 2.10.2 to 2.19.9 in /app/android ([#2209](https://github.com/FAIMS/FAIMS3/pull/2209))
- build(deps): bump aws-cdk-lib from 2.258.0 to 2.260.0 ([#2208](https://github.com/FAIMS/FAIMS3/pull/2208))
- build(deps-dev): bump @vitest/browser from 4.1.8 to 4.1.10 ([#2207](https://github.com/FAIMS/FAIMS3/pull/2207))
- build(deps): bump body-parser from 1.20.3 to 1.20.6 ([#2206](https://github.com/FAIMS/FAIMS3/pull/2206))
- build(deps): bump dompurify from 3.4.11 to 3.4.12 ([#2205](https://github.com/FAIMS/FAIMS3/pull/2205))
- chore: couch db version upgrade guide and instrumentation ([#2204](https://github.com/FAIMS/FAIMS3/pull/2204))
- feat: designer - add warning in designer if field ID is updated and show records count ([#2203](https://github.com/FAIMS/FAIMS3/pull/2203))
- fix: enforcing char limit on survey name. ([#2202](https://github.com/FAIMS/FAIMS3/pull/2202))
- add navigatgion in desktop too - bottom navigation ([#2200](https://github.com/FAIMS/FAIMS3/pull/2200))
- feat: typed computed fields - ComputedNumber and ComputedText (#2197) ([#2199](https://github.com/FAIMS/FAIMS3/pull/2199))
- Add TEMPLATE_MANAGER role and give it to TEAM_MANAGER ([#2198](https://github.com/FAIMS/FAIMS3/pull/2198))
- refactor: replace axios with native fetch in api (#2050) ([#2195](https://github.com/FAIMS/FAIMS3/pull/2195))
- fix: number field range defaults to blank instead of 0 to 100 (#2149) ([#2193](https://github.com/FAIMS/FAIMS3/pull/2193))
- fix: intermittent api unit test failure ([#2192](https://github.com/FAIMS/FAIMS3/pull/2192))
- build: improved e2e tests for web, app and API ([#2191](https://github.com/FAIMS/FAIMS3/pull/2191))
- Fix overflowing text in survey ([#2190](https://github.com/FAIMS/FAIMS3/pull/2190))
- feat: rule of hooks ([#2187](https://github.com/FAIMS/FAIMS3/pull/2187))
- fix(app): sort workspace survey list newest-first ([#2185](https://github.com/FAIMS/FAIMS3/pull/2185))
- Chore/tweak capacitor build and add Procfile ([#2184](https://github.com/FAIMS/FAIMS3/pull/2184))
- build(deps): bump excon from 0.112.0 to 1.5.0 in /app/android ([#2183](https://github.com/FAIMS/FAIMS3/pull/2183))
- Remove unnecessary Android permission claims ([#2182](https://github.com/FAIMS/FAIMS3/pull/2182))
- feat: global audit of input lengths across all interfaces ([#2181](https://github.com/FAIMS/FAIMS3/pull/2181))
- fix: csp issue in web ([#2180](https://github.com/FAIMS/FAIMS3/pull/2180))
- Release v1.6.2 ([#2179](https://github.com/FAIMS/FAIMS3/pull/2179))
- Feat: createRecord allows for initial data ([#2178](https://github.com/FAIMS/FAIMS3/pull/2178))
- chore: build config refactor to typed config singleton with shared Zod helpers ([#2175](https://github.com/FAIMS/FAIMS3/pull/2175))
- chore(deps): bump faraday from 1.10.5 to 1.10.6 in /app/android ([#2164](https://github.com/FAIMS/FAIMS3/pull/2164))
- A component to show record history (audit trail) ([#2151](https://github.com/FAIMS/FAIMS3/pull/2151))
- chore(deps): bump nodemailer from 8.0.10 to 9.0.1 ([#2144](https://github.com/FAIMS/FAIMS3/pull/2144))
- chore(deps): bump multer from 2.1.1 to 2.2.0 ([#2143](https://github.com/FAIMS/FAIMS3/pull/2143))
- chore(deps): bump dompurify from 3.4.8 to 3.4.11 ([#2142](https://github.com/FAIMS/FAIMS3/pull/2142))
- build(deps): bump esbuild from 0.25.12 to 0.28.1 ([#2120](https://github.com/FAIMS/FAIMS3/pull/2120))
