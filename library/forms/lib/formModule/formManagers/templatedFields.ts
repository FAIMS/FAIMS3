 ...
 * Description:
 *   Form bindings for templated string evaluation. The evaluation itself
 *   lives in @faims3/data-model (derivedFields) so the API's refresh pass
 *   (#2245) shares it; this module binds it to the field registry and the
 *   tanstack form.
 */
...
// Evaluation core and helpers re-exported from their original home.
export {
  CREATED_TIME_ID,
  CREATOR_NAME_ID,
  formatTimestamp,
...
export type {RecordContext} from '@faims3/data-model';
