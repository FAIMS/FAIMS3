 ...
 * Description:
 *   Resolves the raw field values of a record's parent, for templated strings
 *   and computed expressions. Hoisted from @faims3/forms so the API's refresh
 *   pass (#2245) shares the exact resolution the form runs on view.
 */
