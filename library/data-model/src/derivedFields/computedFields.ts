 ...
 * Description:
 *   Computed field (ComputedNumber/ComputedText) evaluation against current
 *   values, using expressions precompiled at notebook load. Hoisted from
 *   @faims3/forms so the API's refresh pass (#2245) shares the exact
 *   evaluation the form runs on view.
 */
