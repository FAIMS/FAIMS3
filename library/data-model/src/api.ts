...
/** PUT /api/notebooks/:id/uiSpecification — full replace of the design bundle. */
...
export type PutUpdateNotebookUiSpecificationInput = z.infer<
  typeof PutUpdateNotebookUiSpecificationInputSchema
>;
...
/** PUT /api/templates/:id — merge inconsequential root fields only. */
...
/** PUT /api/templates/:id/uiSpecification — full replace of the design bundle. */
export const PutUpdateTemplateUiSpecificationInputSchema =
  NotebookDefinitionSchema;
export type PutUpdateTemplateUiSpecificationInput = z.infer<
  typeof PutUpdateTemplateUiSpecificationInputSchema
>;
